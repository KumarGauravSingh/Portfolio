...
const MainPoster= () =>{
  ...
  <div className="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
    ...
    <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
            ...
            <div className="animeCard1"><span className="block text-indigo-600 xl:inline">Developer</span></div>
            <div className="animeCard2"><span className="block text-indigo-600 xl:inline">Designer</span></div>
            <div className="animeCard3"><span className="block text-indigo-600 xl:inline">Deployer</span></div>
          </h1>
          <br />
